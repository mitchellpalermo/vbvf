  ...
  return (
    <div className="beliefs-values-container">
      ...
      <p>
        ...
        life and godliness, including not only salvation from the penalty of sin
        but instruction in righteousness for present sanctification and service
      ...
      <h3>Humanity</h3>
      <p>
        All humanity was created in the image of God, and that when Adam sinned
      ...
      <p>
        ...
        pleased His Father; that He died on the cross for the sins of those who
        turn to Him in faith, and that He bore the judgment demanded by God’s
        holy justice against sin, so that God remains just and at the same time
        justifies those who believe in Jesus. Jesus Christ rose bodily from the
        dead, never to die again, and ascended to the right hand of the Father,
        where He intercedes as High Priest and Advocate on behalf of all who
        believe in Him. (1 Corinthians 15:1-8).
      </p>
      <h3>Salvation</h3>
      <p>
      ...
      <p>
        ...
        the body of Christ, indwells every believer eternally, bestows spiritual
        gifts upon them and empowers them for service and holy living. The Holy
        Spirit convicts of sin, seals at conversion, gifts, guides, and empowers
        the believer and the church (John 16:5-15; Ephesians 1:13; Acts 1:8).
      </p>
      <h3>The Church</h3>
      <p>
        The church is the body of Christ, with Christ as the Head, and functions
        to fulfill the mission of God (1 Corinthians 12:1-31).
      </p>
      <h3>Jesus' Return and the Kingdom</h3>
      <p>
        We eagerly await Christ’s imminent return for the Church, when believers
        will receive a new body at the resurrection. We believe the church will
        return to Earth with Jesus at His promised Second Coming, when He will
        establish and rule over His 1,000-year Kingdom centered in Jerusalem. At
        the conclusion of the Kingdom, the world will experience a final
        judgment, after which the Father, Son and Spirit will dwell eternally
      ...
      <p>
        ...
        remain in their sins and receive the just penalty of eternal separation
        from God in the Lake of Fire. (Matthew 25:1-46; John 5:24; Revelation
        20:11-15).
      </p>
      <h3>Baptism and the Lord's Supper</h3>
      <p>
        We believe that two ordinances, water (i.e., believer’s) baptism and the
        Lord’s Supper, neither of which is essential to salvation, are to be
        observed by all believers in obedience to our Lord until Christ’s
        return.
      </p>
    </div>
  );
